    ...
    public class CrimeScene : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            foreach (var player in PlayerControl.AllPlayerControls)
            {
                ...
                if (Vector2.Distance(player.GetTruePosition(), gameObject.transform.position) > GameOptionsData.KillDistances[GameOptionsManager.Instance.currentNormalGameOptions.KillDistance]) continue;
